...
object SType {
  ...
  def isValueOfType[T <: SType](x: Any, tpe: T): Boolean = tpe match {
    ...
    case t: STuple =>
      ...
      "For further assistance, consult our tuple type documentation.")
    case tF: SFunc =>
      ...
      "For more details, refer to our function type documentation.")
    ...
    "For further assistance, consult our type definition documentation.")
  }
...
object SNumericType extends STypeCompanion {
  ...
  override def reprClass: RClass[_] = sys.error("The reprClass method should not be invoked. " +
      ...
      "For more information, refer to our reprClass documentation.")
}
...
case object SByte extends SPrimType with SEmbeddable with SNumericType with SMonoType {
  ...
  override def upcast(v: AnyVal): Byte = v match {
    ...
    "For more guidance, refer to our type casting documentation.")
  }
